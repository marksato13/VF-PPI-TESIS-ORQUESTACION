...
## Cambio de revista objetivo — 26 de agosto de 2026

La coordinación entregó una **lista de control de 17 revistas ya registradas**.
Las tres candidatas que encabezaban la selección figuran en ella:

| Lista | Revista | Cómo la registra la lista |
|---:|---|---|
| N.º 8 | Bulletin of Electrical Engineering and Informatics (BEEI) | Q1 · Indonesia · USD 385 |
| N.º 7 | International Journal of Safety and Security Engineering (IJSSE) | Q3 · Reino Unido · USD 700 |
| N.º 5 | IJACSA | Q3 · Reino Unido · USD 1 100 |

> La lista y las fuentes oficiales **no coinciden**. BEEI es Q1 por CiteScore y
> **Q3 por SJR**; el APC vigente de IJSSE es **USD 850**, no 700. Las
> discrepancias se dejan a la vista en vez de promediarse.

Se buscó una revista fuera de esa lista, aplicando los mismos filtros de
...
| | Revista | Editor | Puntaje | h5 | Acceso abierto | APC | Art./año |
|---|---|---|---:|---:|---|---|---:|
...
| **B** | [Bulletin of Electrical Engineering and Informatics](https://beei.org/index.php/EEI) | IAES · Indonesia | **84,0** | **41** | **Diamante — CC BY-SA** | USD 415 | 377 |
| **C** | [Int. J. of Safety and Security Engineering](https://www.iieta.org/Journals/IJSSE) | IIETA · Canadá | 75,5 | — | Híbrido — **CC BY** | USD 850 | **253** |
| **D** | [Ingénierie des Systèmes d'Information](https://www.iieta.org/Journals/ISI) | IIETA · Francia | 69,0 | 23 | Híbrido — **CC BY** | USD 850 | **305** |

**Las cuatro revistas las eligió el autor; el orden sale del puntaje.** Lo exige
la Sesión 04 en cuatro diapositivas (24, 31, 34 y la rúbrica de la 35), así que
se calcula desde la matriz en vez de escribirse a mano — ver
[`docs/entregables/09-matriz-revistas/`](../entregables/09-matriz-revistas/).
...
| Criterio | **A** IJIES | **B** BEEI | **C** IJSSE | **D** ISI |
|---|:--:|:--:|:--:|:--:|
...
Publica 11 artículos sobre detección de intrusiones desde 2024. Es la de menor puntaje de las cuatro (69,0) y por eso queda de última: entra
por acceso abierto verificado y volumen suficiente, no por mérito comparativo.
**Su plazo medido es el peor del conjunto**: mediana de 250 días hasta publicar.
...
|---|---:|---|
| **IJIT** · Springer | **648 / 714 — 90,8 %** | Llegó a ser Plan B en agosto. Publicar es gratis; abrir el artículo cuesta **USD 3.390** |
...
- **BEEI (Plan B)** es el caso más llamativo: cero artículos cerrados, licencia
...
[ficha en Scopus](https://www.scopus.com/sourceid/21100199814)

**Los seis datos sensibles están verificados en la propia revista**, no en
fuentes secundarias.

| Dato | Valor | Fuente |
|---|---|---|
| Scopus | CiteScore 4,2 · SNIP 0,854 | [página de indexación](https://cit.iict.bas.bg/cit-indexing.html) |
...
| Número | Artículo |
|---|---|
| 2025 · n.º 4 | *Edge-Fog-Cloud Distributed Architecture for Intelligent **DDoS Detection and Mitigation*** |
| 2026 · n.º 2 | *Cross-Dataset DDoS Intrusion Detection Using Hybrid Welch-Point-Biserial Feature Selection and DenseMLP* |
| 2026 · n.º 1 | *ChSp-ACN: Channelized Spatial Attention Enabled Adam-Optimized Convolutional Neural Network for Intrusion Detection* |
...
**Las 20 páginas importan.** BEEI da 8 de base y cobra USD 50 por cada página
extra. Este artículo tiene que exponer 28 variables, la calibración del umbral y
la brecha entre el error de laboratorio (4,71 %) y el de operación (23–26 %). En
CIT eso entra completo.
...
| Revista | Motivo |
|---|---|
| **Journal of Cybersecurity and Privacy** · MDPI | CiteScore 9,1 y encaje perfecto, pero **figura en la lista de revistas depredadoras** que se usó como filtro (entrada 1853). Queda fuera sin discusión |
...
| ~~**Ingénierie des Systèmes d'Information** · IIETA~~ | **Readmitida el 26/08/2026 y hoy es el Plan D.** Se había descartado por su alcance declarado, aplicando un criterio que no se usó con las demás: a CIT se la juzgó por lo que publica, no por su alcance. Con el mismo rasero, ISI publica **11 artículos de detección de intrusiones desde 2024** |
...
| **ISI** (Plan D) | 149 a 266 días · **mediana 156** | 244 a 315 días · **mediana 250** |
...
| **ISI sí respeta sus 6-12 páginas** | Sus 4 artículos miden 8, 10, 11 y 12 | En el Plan D hay que ajustarse de verdad |
...
| Tema | Documento |
|---|---|
| Matriz de decisión de revistas | [`../entregables/09-matriz-revistas/`](../entregables/09-matriz-revistas/matriz-decision-revistas.md) |
...
la revisión «2026-08-26-revision-verificacion-revistas-codex» (en el historial del repositorio)
...
| **C-11** | **El orden de los planes no seguía el puntaje**, y la rúbrica de la Sesión 04 lo califica: el Plan B era ISI (69,0) con BEEI (84,0) por delante | **Alta** | Corregida el 02/09/2026: el orden se **calcula** desde la matriz |
...
como acceso abierto diamante sin cargo, y la propia revista publica un APC que
