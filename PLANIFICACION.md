...
| # | Paso | Sale en |
|---|---|---|
| 1 | Inventario completo | `04-evidencias/` |
| 2 | Matriz de requisitos | `02-metodologia/trazabilidad/requisitos.md` |
| 3 | Mapa de evidencias | `02-metodologia/trazabilidad/requisitos-a-evidencias.csv` |
| 4 | Auditoría de afirmaciones | `02-metodologia/trazabilidad/afirmaciones-cientificas.md` |
| 5 | Reconciliación de fases | `02-metodologia/fases/` |
| 6 | Reestructuración documental | producto |
| 7 | Auditoría del producto | producto |
| 8 | Mejoras priorizadas | `ESTADO.md` |
| 9 | Pruebas nuevas | producto |
| 10 | Actualización de tesis y cronograma | `03-entregables/` |
