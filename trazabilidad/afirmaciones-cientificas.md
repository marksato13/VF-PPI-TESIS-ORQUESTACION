...
|---|---|---|---|
| `CLAIM-001` | ROC-AUC de 0,9741 sobre el conjunto de prueba | **OBTENIDO** | `fase04-modelado/07-metricas-clasificacion-comparacion-7-modelos.md` |
| `CLAIM-002` | Detección del 88,8 % sobre ataques genuinos (143/161) | **OBTENIDO** | `fase04-modelado/06-modelo-final-congelado-ocsvm.md` |
| `CLAIM-003` | FPR de 4,71 % en laboratorio (13/276), IC [2,8 – 7,9] | **OBTENIDO** | `fase04-modelado/09-validacion-cruzada-y-estabilidad.md` |
| `CLAIM-004` | FPR de 25,81 % y 22,97 % en operación real | **OBTENIDO** | `fase07-validacion-final/02-resultados-f6.md` |
...
| `CLAIM-007` | El pipeline es determinista: 10 ajustes → mismo SHA-256 | **VALIDADO** | `fase04-modelado/09-validacion-cruzada-y-estabilidad.md` |
| `CLAIM-008` | Umbral estable: CV 4,10 %, banda [1,6496 – 1,8132] | **OBTENIDO** | ídem |
| `CLAIM-009` | Las variables multicapa elevan la detección de 66,5 % a 88,8 %, p < 0,001 | **OBTENIDO** | `fase04-modelado/07-ablacion-multicapa.md` |
| `CLAIM-010` | Las 6 comparaciones del OCSVM son significativas (McNemar + Holm, 21 pares) | **OBTENIDO** | `fase04-modelado/08-significancia-entre-modelos.md` |
| `CLAIM-011` | Reproducibilidad: al reevaluar salen 13/276 y 158/179 exactos | **VALIDADO** | `entregables/02-validacion-y-confiabilidad/` |
