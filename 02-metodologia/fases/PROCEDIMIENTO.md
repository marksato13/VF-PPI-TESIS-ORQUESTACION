...
Cada cifra de este documento sale de una evidencia con su comando
detrás. Para comprobar una:

```bash
grep -rn "<la cifra>" 04-evidencias/       # dónde se midió
grep -rn "<la cifra>" 02-metodologia/trazabilidad/   # qué afirmación sostiene
```
