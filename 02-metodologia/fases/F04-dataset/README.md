...
| | |
|---|---|
| **Identificador** | `PHASE-04` |
| **Estado** | Congelado |

## Objetivo

Composición auditada, particiones disjuntas y hashes publicados.

## Criterios de entrada

Sin esto, la fase no empieza:

- Contrato de variables cerrado
...
- Datasheet de 11 secciones
- Gates de duplicados y constantes
